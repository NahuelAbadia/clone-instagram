...
const Navbar = () => {
    return (
        <Stack>
            <Container alignSelf="center" maxWidth="container.lg" paddingX={10}>
                {/* <Container alignSelf="center" maxWidth="container.lg" paddingX={10}> */}
                    <Stack direction="row" pt={3} alignItems="center" justify="space-between" boxShadow="xs">
                        <Image src={logo} />
                        <Stack alignItems="center" direction="row" height="28px" maxWidth="215px" width="100%"
                            ...
                            <Input placeholder="Buscar" paddingX={2} variant="unstyled" />
                        </Stack>
